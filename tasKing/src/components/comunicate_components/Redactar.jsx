...
export function Redactar() {
    return (
        <div className='w-[100%] h-[100%] flex border-l-4'>
            <div class=" w-full mx-auto p-4 bg-white rounded-r-3xl max-sm:rounded-3xl shadow-lg max-sm:w-[100%]">
                <form className=' mt-4 ml-2 mr-2'>
                    ...
                    <div class="flex justify-between">
                        <button type="button" class="inline-flex justify-center w-[15rem] max-sm:mr-6 py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">ENVIAR</button>
                        <button type="submit" class="inline-flex justify-center w-[15rem]  py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Cancelar</button>
                    </div>
                </form>
            </div>
        </div>
