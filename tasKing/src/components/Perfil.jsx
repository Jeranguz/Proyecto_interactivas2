...
export function Perfil() {
    return (
        ...
        <div>
            ...
            <div class="grid laptop:grid-cols-[repeat(2_,1fr)] md:grid-cols-3 grid-cols-1 gap-4 mt-4 h-[80vh] ">
                ...
                <div>
                    ...
                    <div className='laptop:w-[46rem] grid grid-cols-2 max-[500px]:grid-cols-1 justify-items-center justify-center'>
                        ...
                        <div class="rounded-lg overflow-hidden shadow-lg bg-white p-4 relative h-[13.5rem] mb-[1rem] ">
                            <div class="flex items-center space-x-4 mt-[2rem]">
                                <div class="relative">
                                    <img class='w-[105%] h-[100%] rounded-full border-2 border-purple-500' src={Profile} alt=""/>
                                    <div class="absolute -bottom-1 -right-1 bg-purple-500 p-2 rounded-full">
                                        <button className='w-[1.5rem] h-[0.5rem]'> <img src="" alt="" />
                                        </button>
                                    </div>
                                </div>
                                <div>
                        ...
                        {/* Cursos Matriculados */}
                        <div class="col-span-1 bg-white p-5 rounded-lg shadow-md mb-[1rem] ml-4 w-[96%] max-[500px]:ml-0 max-[500px]:w-[100%]">
...
>>>>>>> 43d2984be902bd34880a5bf78ee41aac7ac5ecfe
    );
}
