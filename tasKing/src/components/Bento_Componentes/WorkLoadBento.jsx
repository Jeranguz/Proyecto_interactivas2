import '../../index.css';
export function WorkLoadBento() {
    return (
        <div className='h-full bg-textWhite col-start-4 col-end-5 px-8 py-5 rounded-3xl w-full row-span-1'>
            <h2 className='text-primary text-[clamp(1rem,_2vw,_3rem)] font-bold text-center'>Carga semanal</h2>
            <div className="mt-[10%] relative flex aspect-[2] w-[70%] m-auto items-center justify-center overflow-hidden rounded-t-full bg-green-500">
