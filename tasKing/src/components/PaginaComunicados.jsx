      ...
      <div className='flex '>
        ...
        <div className='mt-[8vh] laptop:mt-0 w-[90%]  laptop:w-[75%]  m-auto '>
          ...
          <div className='grid w-full laptop:mb-0 laptop:flex  mt-4 mb-[15vh] laptop:grid-cols-1'>
            <div className='w-1/4 max-sm:w-full max-sm:rounded-3xl max-sm:mb-4  max-md:rounded-3xl max-md:mb-4 max-laptop:w-[100%] max-laptop:rounded-3xl max-laptop:mb-4 bg-white dark:bg-zinc-900 p-5 rounded-l-3xl'>
