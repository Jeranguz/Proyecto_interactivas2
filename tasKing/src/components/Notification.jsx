...
export function Noti(){
    ...
    return(
        <div>
            <h1 className="flex my-8 mx-8">Notificaciones</h1>
            <div className="flex items-center justify-between mx-8 my-8">
                <div className="flex gap-4 items-center">
                    <button className="text-sm text-gray-600 hover:text-gray-800" onClick={selectAll}>Todas</button>
                    <button className="text-sm text-gray-600 hover:text-gray-800" onClick={selectNull}>Ninguna</button>
                    <button className="text-sm text-gray-600 hover:text-gray-800" onClick={showRead}>Leídas</button>
                    <button className="text-sm text-gray-600 hover:text-gray-800" onClick={showUnread}>No leídas</button>
                    <button className="text-sm text-gray-600 hover:text-gray-800" onClick={highLighted}>Destacadas</button>
                    <button className="text-sm text-gray-600 hover:text-gray-800" onClick={noHighLighted}>No destacadas</button>
                </div>
                <div className="flex gap-2 items-center">
                    <span className="text-sm text-gray-500">Página 1 de 5</span>
                </div>
            </div>
        </div>
    )
