...
function SignInRegister() {
    ...
    return (
        <div className="relative grid md:grid-cols-2 grid-rows-2 h-[90vh] w-[90vw] mx-[5vw] mt-[2.5vw] bg-white transition-colors duration-500 overflow-hidden">
            ...
            <form className="flex flex-col  justify-center items-center space-y-4  gap-y-[2vh] text-[2vw] md:text-base z-10 mt-8 md:mt-16">
            ...
            <form className="flex flex-col align-middle justify-center items-center space-y-4 gap-y-[2vh] text-[2vw] md:text-base z-10 mt-8">
