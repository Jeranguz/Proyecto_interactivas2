...
function SignInRegister() {
    ...
    return (
        <div className="relative grid items-start md:grid-cols-2 grid-rows-2 h-[90vh] w-[90vw] mx-[5vw] mt-[2.5vw] bg-white transition-colors duration-500 overflow-hidden">
            ...
            <form onSubmit={submitLogin} className="flex flex-col justify-start items-center laptop:space-y-4 sm:gap-y-[2vh] text-[2vw] md:text-base z-10  gap-y-6  sm:mt-8 md:row-start-1 min-h-[50vh]">
            ...
            <form onSubmit={submitRegister} className="flex flex-col justify-center items-center space-y-4 sm:gap-y-[2vh] text-[2vw] md:text-base z-10 sm:mt-8 mt-[50%] md:row-start-1 min-h-[50vh]">
                ...
                <div className="flex flex-wrap -mx-2">
                    <div className="px-2 w-1/2 md:w-1/2">
                        <input onChange={(e) => setNameRegister(e.target.value)} type="text" placeholder="Name" className="p-2 w-full border border-gray-300 rounded" name='name' />
                    </div>
                    <div className="px-2 w-1/2 md:w-1/2">
                        <input onChange={(e) => setLastNameRegister(e.target.value)} type="text" placeholder="Last Name" className="p-2 w-full border border-gray-300 rounded" name='lastname' />
                    </div>
                </div>
                <div className="flex flex-wrap -mx-2">
                    <div className="px-2 w-1/2 md:w-1/2">
                        <input onChange={(e) => setUserNameRegister(e.target.value)} type="text" placeholder="UserName" className="p-2 w-full border border-gray-300 rounded" name='username' />
                    </div>
                    <div className="px-2 w-1/2 md:w-1/2">
                        <input onChange={(e) => setEmailRegister(e.target.value)} type="email" placeholder="Email" className="p-2 w-full border border-gray-300 rounded" name='email' />
                    </div>
                </div>
                <input onChange={(e) => setPasswordRegister(e.target.value)} type="password" placeholder="Password" className="border-gray-300 rounded p-2 w-[80vw] md:w-[30vw]" name='password' />
