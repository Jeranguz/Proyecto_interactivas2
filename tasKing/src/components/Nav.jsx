...
export function Nav() {
    return (
        <nav className="bg-primary flex justify-between h-[4.688rem] p-4 gap-4">
            <h1 className='flex items-center gap-2 text-3xl text-neutral-50 font-bold'><img className="h-11" src={Logo} alt="logo"/>TasKing</h1>
            ...
            <a className="flex gap-4 items-center" href="#">
                <p className="text-elements text-xl">Jason</p>
