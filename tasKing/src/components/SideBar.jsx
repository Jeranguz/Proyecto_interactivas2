            ...
            <div className=" z-10 bg-primary w-full lg:min-h-screen h-[10vw] flex bottom-0 fixed lg:relative lg:h-full lg:w-[20vw] xl:left-0">
                <div className='p-[1.5vw] self-center'>
                    ...
                    <div className='flex lg:flex-col'>
                        {options.map(option => (
                            <Link to={option.href} className='w-[15vw] lg:w-full flex flex-row  justify-center lg:justify-start gap-[1.5vw] bg-primary p-[1.5vw] rounded-2xl lg:mt-5 hover:bg-white text-white hover:text-primary'>
                                <img className='self-center w-[4vw] lg:w-[1.5vw] filter invert' src={Icono} alt="" />
